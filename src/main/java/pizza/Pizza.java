...
public class Pizza extends AbstractMenuItem {
	...
	/**
	 * Clears all the components of the pizza.
	 *
	 * This method is typically used when the user wants to start creating a new pizza from scratch.
	 */
	public void clearPizzaComponents() {
		this.pizzaComponents.clear();
	}
}
